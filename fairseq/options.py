...
def add_cmlm_da_args(parser):
    group = parser.add_argument_group('CmlmDa')
    group.add_argument("--cmlm-soft",action='store_true',default=False,help="train with soft augmentation")
    group.add_argument('--cmlm-src-config', type=str, default=None,
                       help='config for source config')
    group.add_argument('--cmlm-tgt-config', type=str, default=None,
                       help='config for target config')
    group.add_argument('--cmlm-src-ckpt', type=str, default=None,
                       help='path to restore cmlm checkpoints')
    group.add_argument('--cmlm-tgt-ckpt', type=str, default=None,
                       help='path to restore cmlm checkpoints')
    group.add_argument('--cmlm-alpha', default=0.15, type=float,
                            help='mask propability for decoder module')
    group.add_argument('--cmlm-temper', default=1, type=float,
                            help='temperature for cmlm sampling')
    return group

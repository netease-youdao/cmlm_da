...
def load_langpair_dataset(
    ...
    return LanguagePairDataset(
        ...
        cmlm_src_da=cmlm_src_da,
        cmlm_tgt_da=cmlm_tgt_da,
        cmlm_alpha=cmlm_alpha
...
class TranslationTask(FairseqTask):
    ...
    def load_dataset(self, split, epoch=0, combine=False, **kwargs):
        ...
        self.datasets[split] = load_langpair_dataset(
            ...
            cmlm_src_da=self.args.cmlm_src_config is not None,
            cmlm_tgt_da=self.args.cmlm_tgt_config is not None,
            cmlm_alpha=self.args.cmlm_alpha,
        )
